...
def login():
    ...
    uname = e_username.get()
    with open('uname_s.txt', 'w') as f:
        f.write(uname)
    ...
    if get_username == "" or get_pwd == "":
        ...
        try:
            ...
            sql = "select * from staff_login where Username=%s and Password=%s"
...
reglb = Label(frame1, text="Staff Login", font="Verdana 15 bold", bg="#4169E1")
reglb.place(x=35, y=255)
